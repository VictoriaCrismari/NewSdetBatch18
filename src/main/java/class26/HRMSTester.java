...
public class HRMSTester {
    public static void main(String[] args) throws IOException {
        ...
        String path ="C:\\Users\\crism\\IdeaProjects\\NewSdetBatch18\\Files\\hrmsTester.xlsx";
        ...
        webDriver.get(url);
        WebElement userNameWE= webDriver.findElement(By.xpath("(//input[@id='txtUsername'])[1]"));
